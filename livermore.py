...
if __name__ == '__main__':
    ...
    #         doing_long = False
    #
    #     if had_up_trend and had_down_trend:
    #         in_trade = True
    #
    #     if not in_trade:
    #         continue
    #
    #     if doing_long:
    #         lowest_today = day_lowest[line[0]]
    #         if lowest_today <= 0.9*cost:
    #             # 止损
    #             stopped_loss = True
    #             money = money * 0.9
    #             cost = 0
    #             print(f"{line[0]} {0.9*cost} 止损，money：{money}")
    #         if line[4] != "":
    #             price = float(str(line[4]).removesuffix("-o").removesuffix("-x"))
    #             doing_long = False
    #             if not stopped_loss:
    #                 money = (1+(price - cost) / cost) * money
    #             print(f"{line[0]} {price} 平多做空，money：{money}")
    #             cost = price
    #             stopped_loss = False
    #     else:
    #         highest_today = day_highest[line[0]]
    #         if highest_today >= 1.1 * cost:
    #             stopped_loss = True
    #             money = money * 0.9
    #             cost = 0
    #             print(f"{line[0]} {1.1*cost} 止损，money：{money}")
    #         if line[3] != "":
    #             price = float(str(line[3]).removesuffix("-o").removesuffix("-x"))
    #             doing_long = True
    #             if not stopped_loss:
    #                 money = (1+(cost - price)/ cost) * money
    #                 print(f"{line[0]} {price} 平空做多，money：{money}")
    #                 cost = price
    #                 stopped_loss = False
